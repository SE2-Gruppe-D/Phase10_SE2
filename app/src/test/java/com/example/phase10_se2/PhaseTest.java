...
//Phase 4 Test
    ...
    @Test
    public void afterCheckingPhase4AndAddOneCard_ThenReturnTrue() {
        list.add(cft.card1y);
        list.add(cft.card5y);
        list.add(cft.card2y);
        list.add(cft.card3g);
    ...
    @Test
    public void afterCheckingPhase3AndAddOneCard_ThenReturnTrue() {
        list.add(cft.card1y);
        list.add(cft.card8r);
        list.add(cft.card2y);
        list.add(cft.card3g);
    ...
    @Test
    public void afterCheckingPhase3AndAddOneCard_ThenReturnFalse() {
        list.add(cft.card1y);
        list.add(cft.card8r);
        list.add(cft.card2y);
        list.add(cft.card3g);
